...
├── scripts/
│   ├── lib.sh            # Shared utilities (colors, selectors, env loader)
...
│   ├── modify.sh         # Interactive: change CPU/memory limits
│   ├── remove.sh         # Interactive: permanently delete a runner
│   ├── logs.sh           # Interactive log viewer
│   └── describe.sh       # Display runner configs with live status
